...
<body oncontextmenu='return false' class='snippet-body'>
				...
				<div class="forgot">
					...
					<ol class="list-unstyled">
						...
						<li><span class="text-primary text-medium">2. </span>Our
							system will send you an Token to your email</li>
						<li><span class="text-primary text-medium">3. </span>Enter the Token on the 
						next page</li>
					</ol>
				</div>
	...
	out.print(request.getAttribute("status1"));}
	%>
